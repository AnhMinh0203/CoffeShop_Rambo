...
//        int numRows = (listTable.size() + 5) / 3; // Số hàng tính theo mỗi 6 nút
        int numColumns =3; // Số cột

        int buttonCount = 0; // Biến đếm số lượng nút đã thêm vào
        
        ImageIcon imageIcon = new ImageIcon("E:\\JavaProgrammingEAUT\\BaiTapLon\\Coffee_Rambo\\src\\Images\\table.png");
        Image img = imageIcon.getImage().getScaledInstance(buttonWidth-100, buttonHeight, Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(img);
        
//        int jPanelWidth = numColumns * buttonWidth + 20*numColumns ;
//        int jPanelHeight = 20 * buttonHeight  ;
//        jPanel1.setPreferredSize(new Dimension(jPanelWidth, jPanelHeight));
        ...
        for (TableFood table : listTable) {
            ...
            jButton1.setText(table.getTableName());
